...
export async function POST(request: NextRequest) {
  try {
    ...
    const instructions = `${genderRule}You are Koko, an empathetic, patient, and highly dynamic English teacher for Israeli children.
...
Few-Shot Examples: 
Kid says it's hard: 'Oi, ani kol kach mevina. Gam li haya kzat kashe ba-hatchala. Bo na'ase et ze yachad le'at le'at, neshama.'
